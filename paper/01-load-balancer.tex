...
\begin{axis}[
    ...
    xmin=70, xmax=98,
    symbolic y coords={%
      consilience,control,biomimetic,reflective,%
      flaneur,subtle,explicit,contrarian},
    ytick={consilience,control,biomimetic,reflective,%
      flaneur,subtle,explicit,contrarian},
    yticklabels={consilience,\textbf{control},biomimetic,reflective,%
      flaneur,subtle,explicit,contrarian},
...
\begin{axis}[
    ...
    xmin=-5, xmax=25,
    symbolic y coords={%
      subtle,flaneur,reflective,biomimetic,%
      explicit,consilience,contrarian},
    ytick=data,
    ytick style={draw=none},
    bar width=7pt,
...
\end{axis}
\end{tikzpicture}
\caption{Benchmark score vs.\ API cost.  Control (blue square) is the
most cost-efficient.  Contrarian (top right) delivers the best absolute
score but costs 2.6$\times$ more.}
\label{fig:cost}
\end{figure}
...
\end{axis}
\end{tikzpicture}
\caption{Research effort (subagent tokens) vs.\ knowledge extraction
(Wikipedia articles referenced in final code).  Explicit researched the
most but extracted nothing; contrarian researched less but extracted
